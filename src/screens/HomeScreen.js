...
const RegisterScreen = ({ navigation }) => {
  ...
  const [usercnfPassword, setUsercnfPassword] = useState('');
  ...
  const cnfpwdInputRef = createRef();
 const handleSubmitButton = () => {
  ...
  return (
      ...
      <ScrollView
        ...
        <KeyboardAvoidingView enabled>
          ...
          <View style={styles.SectionStyle}>
            <TextInput
              style={styles.inputStyle}
              onChangeText={(usercnfPassword) => setUsercnfPassword(usercnfPassword)}
              underlineColorAndroid="#f000"
    ...
    <Image source={require('../Images/google.png')}style={{ width: 50,marginLeft:10, height: 50 }} />
  </View>
      </ScrollView>
